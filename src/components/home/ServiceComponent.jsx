          ...
          <div className="flex flex-col md:flex-row md:justify-center items-center md:flex-wrap 2xl:gap-[15rem] mt-12 mb-12">
            ...
            <div className="text-center md:text-start max-w-full md:max-w-[30rem]">
              ...
              <div className="flex justify-center md:justify-start mt-4">
                <ButtonPrimaryUi to="/structured-finance" text="Know more">
                  Know more
                </ButtonPrimaryUi>
              </div>
            </div>
        ...
        <div className="flex flex-col md:flex-row md:justify-center items-center md:flex-wrap 2xl:gap-[15rem] mt-12 mb-12">
          <div className="text-start text-wrap m-4">
            ...
            >
              ...
              investors. Our step-by-step guide emphasizes transparency,
              efficiency, and strategic deployment of funds to maximize project
              success.
            </p>
            <div className="flex gap-2 mt-4 pl-5 pr-5 md:pr-0 md:pl-0">
              <ButtonPrimaryUi to="/asset-monetization" text="Know more">
                Know more
              </ButtonPrimaryUi>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row md:justify-center items-center md:flex-wrap 2xl:gap-[15rem] mt-12 mb-12">
            ...
            <div className="text-start text-wrap">
              ...
              >
                Unlock liquidity without selling stocks. Epiidosis Investments
                LLC offers loans against listed stocks, ensuring quick access to
