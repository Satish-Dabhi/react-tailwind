...
const cards = [
  {
    imageSrc: "/img/assetmonetization/unlockvalue.png",
  ...
  {
    imageSrc: "/img/assetmonetization/rigorousduediligence.png",
  ...
  {
    imageSrc: "/img/assetmonetization/globalreach&flexiblesolutions.png",
...
const HeroSectionAssetMonetization = () => {
  return (
    <div className="relative w-full max-h-auto sm:min-h-[55rem] 2xl:min-h-[40rem]">
      <Carousel>
        <div
          style={{ backgroundImage: `url(${herosectionfundraising})` }}
          className="relative w-full h-[550px] bg-cover bg-center bg-no-repeat md:h-[420px]"
        >
          <div className="absolute inset-0 flex flex-col container mx-auto">
            ...
            <div className="ml-12">
              <p className="text-white mt-5 text-xl md:text-start md:text-4xl font-inria">
                Unlock the Value of Your Assets<br></br>with Epiidosis Investments
              </p>
              <p className="md:w-[80%] md:text-lg text-gray-400 mt-6 font-inter">
