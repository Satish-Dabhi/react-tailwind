  ...
  return (
    <>
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-center gap-8 p-5 mt-12 mb-12">
        <img
          src={investcoPortalImage}
          alt="The InvestcoPortal - Investment Fundraising Automation"
        ...
        <div className="text-start md:w-[30rem]">
          ...
          <ul className="list-disc ml-5 text-gray-600 mt-3 font-inria">
            ...
            <li>
              Access to diverse industries including technology, healthcare,
              finance, and more.
            </li>
            <li>
              Focus on strategic private investments with promising growth
              prospects.
            </li>
          </ul>
        </div>
      ...
      <div className="bg-bgprimary p-5">
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-center gap-8 p-5 mt-12 mb-12">
          <div className="text-start md:w-[30rem]">
            ...
            <ul className="list-disc ml-5 text-gray-600 mt-3 font-inria">
              <li>
                <strong>SPV Model:</strong> Isolates financial risk by using
                Special Purpose Vehicles for finance structuring.
              </li>
              <li>
                <strong>Collateral:</strong> SPV shares provide a tangible form
                of security to investors.
              </li>
              <li>
                <strong>Risk Mitigation:</strong> Provides added protection with
