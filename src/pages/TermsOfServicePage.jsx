  ...
  return (
    <div className="container mx-auto p-5">
      ...
      <p style={{ fontSize: 15 }}>
        ...
        "Epiidosis Investments," "we," "us," or "our"). By accessing or using
        our Website, you agree to comply with and be bound by these Terms &
        Conditions. These Terms & Conditions outline the rules and regulations
        for the use of our Website. By accessing this Website, you accept these
        Terms & Conditions in full. If you disagree with any part of these Terms
        & Conditions, you must not use our Website. We reserve the right to
        modify or replace these Terms & Conditions at any time without prior
        notice. Your continued use of the Website after any such changes
        constitutes acceptance of the new Terms & Conditions. Please review this
        page periodically for updates. If you have any questions or concerns
        about these Terms & Conditions, please contact us at
      ...
      <p style={{ fontSize: 15 }}>
        ...
        agree to be bound by these Terms & Conditions ("Terms"). These Terms
        govern your access to and use of the Site, including any content,
        functionality, and services offered on or through the Site. Please read
        these Terms carefully before using the Site. By accessing or using the
        Site, you acknowledge that you have read, understood, and agree to be
        bound by these Terms and our Privacy Policy, which is hereby
        incorporated by reference. If you do not agree to these Terms or the
        Privacy Policy, you must not access or use the Site. We reserve the
        right to modify, amend, or update these Terms at any time without prior
        notice. Any changes to these Terms will be effective immediately upon
        posting on this page. Your continued use of the Site following the
        posting of any changes constitutes acceptance of those changes. It is
        your responsibility to review these Terms periodically for updates. If
        you have any questions about these Terms or the Site, please contact us
        at legal@epiidosisinvestments.com or +971-4-884-8644.
      </p>
      ...
      <ol className="text-lg font-inter p-10 list-decimal">
        ...
        <li style={{ fontSize: 15 }}>
          ...
          engages in conduct that Epiidosis Investments LLC deems inappropriate,
          harmful, or illegal.
        </li>
      </ol>
      <p style={{ fontSize: 15 }}>
      ...
      <p style={{ fontSize: 15 }}>
        ...
        confidentiality of their account credentials and for all activities that
        occur under their account. Epiidosis Investments LLC reserves the right
        to suspend or terminate accounts found to be in violation of these Terms
        & Conditions or engaged in fraudulent or unauthorized activities. Users
        are required to promptly notify Epiidosis Investments LLC of any
        unauthorized use of their account or any other breach of security.
        Epiidosis Investments LLC shall not be liable for any loss or damage
        arising from unauthorized access to or use of a user's account.
      </p>
      <h1 className="text-primary text-4xl mt-12 mb-5 font-semibold font-inria">
        User Content
      </h1>
      ...
      <p style={{ fontSize: 15 }}>
        ...
        activities on the website. Users are encouraged to report any suspected
        violations of these terms to the designated contact provided on the
        website.
      </p>
      ...
      <p style={{ fontSize: 15 }}>
        ...
        services. You acknowledge and agree that Epiidosis Investments LLC shall
        ...
        through any such websites or services. We strongly advise you to read
      ...
      <p style={{ fontSize: 15 }}>
        ...
        of the website or its contents, any derivative use of the website or its
      ...
      <p style={{ fontSize: 15 }}>
        ...
        unauthorized use of the website's content or trademarks may violate
        copyright, trademark, and other applicable laws and could result in
        legal action. Epiidosis Investments LLC reserves all rights not
        expressly granted in these Terms & Conditions, and users agree to abide
      ...
      <p style={{ fontSize: 15 }}>
        ...
        holders' rights and explains the procedures for addressing copyright
      ...
      <ol className="text-lg font-inter p-10 list-decimal">
        <li style={{ fontSize: 15 }}>
          ...
          or its licensors and is protected by copyright laws. Users are
          prohibited from reproducing, distributing, modifying, or otherwise
        ...
        <li style={{ fontSize: 15 }}>
          ...
          <div className="mt-3 pl-10 ">
            ...
            <p className="font-medium">Epiidosis Investments LLC </p>
            <p className="font-medium">
              Address: 818, Park Lane Tower, Business Bay, Dubai – 415203,
              United Arab Emirates
            </p>
            <p className="font-medium">Email: legal@epiidosisinvestments.com</p>
        ...
        <li style={{ fontSize: 15 }}>
          ...
          <ul className="list-disc pl-10 mt-3">
            ...
            <li style={{ fontSize: 15 }}>
              ...
              States district court, if your address is outside of the United
              States), and that you will accept service of process from the
              person who provided the Infringement Notice or an agent of such
              person.
            </li>
          </ul>
        </li>
      ...
      <p style={{ fontSize: 15 }}>
        ...
        content and termination of access to the website.
      </p>
      <h1 className="text-primary text-4xl mt-12 mb-5 font-semibold font-inria">
        Trademarks
      </h1>
      <p style={{ fontSize: 15 }}>
        ...
        third-party licensors. Users are prohibited from using any of the
        trademarks or logos without the prior written permission of Epiidosis
        Investments LLC or the respective trademark owner. Unauthorized use of
        trademarks may constitute infringement and could result in legal action.
        By accessing and using the website, users agree to respect the
        intellectual property rights of Epiidosis Investments LLC and its
        affiliates.
      </p>
      ...
      <p style={{ fontSize: 15 }}>
        ...
        of User-Generated Content and/or suspension or termination of user
        accounts.
      </p>
      ...
      <p style={{ fontSize: 15 }}>
        ...
        Copyright Act (DMCA). We respect the intellectual property rights of
        others and expect our users to do the same. As part of our commitment to
        ...
        <li style={{ fontSize: 15 }}>
          ...
          <ul className="list-disc pl-10 mt-3">
            ...
            <li style={{ fontSize: 15 }}>
              ...
              original notification of infringement.
            </li>
          </ul>
        </li>
        <li style={{ fontSize: 15 }}>
      ...
      <p style={{ fontSize: 15 }}>
        ...
        our DMCA agent using the information provided above.
      </p>
      ...
      <p style={{ fontSize: 15 }}>
        ...
        viruses or other harmful components. You acknowledge that it is your
        responsibility to implement sufficient procedures and virus checks
      ...
      <p style={{ fontSize: 15 }}>
        ...
        consult with qualified professionals who can provide advice tailored to
      ...
      <p style={{ fontSize: 15 }}>
        ...
        continuing to use our website after any such changes, you agree to be
        bound by the revised Terms & Conditions.
      </p>
      <h1 className="text-xl mt-6 font-semibold mb-3 ">
      ...
      <p style={{ fontSize: 15 }}>
        ...
        posting of changes to this Disclaimer will be deemed your acceptance of
        those changes.
      </p>
      ...
      <p style={{ fontSize: 15 }}>
        ...
        party for any direct, indirect, incidental, special, consequential, or
      ...
      <p style={{ fontSize: 15 }}>
        ...
        or relating to your use of the website, any content you submit or
      ...
      <p style={{ fontSize: 15 }}>
        ...
        claim without the prior written consent of Epiidosis Investments LLC.
      </p>
      ...
      <p style={{ fontSize: 15 }}>
        ...
        these Terms & Conditions. The validity and enforceability of the
        remaining provisions shall not be affected thereby, and they shall
      ...
      <p style={{ fontSize: 15 }}>
        ...
        hereby waive any right to participate in class or collective actions to
        resolve disputes. This waiver applies to any claims or controversies
        arising out of or relating to your use of the website, including but not
        limited to claims under consumer protection laws, privacy laws, and
        other statutory or common law claims. By agreeing to these Terms &
        Conditions, you expressly waive any right to bring, join, or participate
        in any class action lawsuit or class-wide arbitration against Epiidosis
        Investments LLC or its affiliates. If any court or arbitrator determines
        that the waiver of class action is unenforceable, then the dispute shall
        be resolved in accordance with the Arbitration section outlined in these
        Terms & Conditions.{" "}
      </p>
      <h1 className="text-primary text-4xl mt-12 mb-5 font-semibold font-inria">
        Arbitration
      ...
      <p style={{ fontSize: 15 }}>
        ...
        arising from the use of the Website through arbitration. Arbitration
        offers a streamlined and efficient alternative to traditional
        litigation, promoting cost-effective resolution while minimizing the
      ...
      <p style={{ fontSize: 15 }}>
        ...
        enforceability, or formation of these Terms & Conditions, to binding
        arbitration. This agreement to arbitrate encompasses all disputes,
        regardless of whether they arise from contract, tort, statute, or other
        legal theory, and applies to claims seeking monetary, injunctive, or
        equitable relief.
      </p>
      ...
      <p style={{ fontSize: 15 }}>
        ...
        of Commerce (ICC), unless the parties mutually agree otherwise. The
        arbitration shall be conducted by a single arbitrator appointed in
        accordance with the chosen arbitration provider's rules.
      </p>
      ...
      <p style={{ fontSize: 15 }}>
        ...
        claims with those of other users or participate in any representative
        capacity.{" "}
      </p>
      ...
      <p style={{ fontSize: 15 }}>
        ...
        out by contacting legal@epiidosisinvestments.com.
      </p>
      ...
      <p style={{ fontSize: 15 }}>
        ...
        continuing to access or use our website after any revisions become
        effective, you agree to be bound by the revised Terms & Conditions. If
        you do not agree to the new Terms & Conditions, please discontinue use
        of the website.
      </p>
      <h1 className="text-xl mt-6 font-semibold mb-3 ">
      ...
      <p style={{ fontSize: 15 }}>
        ...
        functionalities. Any updates or amendments to the Terms & Conditions
      ...
      <p style={{ fontSize: 15 }}>
        ...
        contact information, you consent to receive electronic communications
      ...
      <ol className="text-lg font-inter p-10 list-decimal">
        ...
        <li style={{ fontSize: 15 }}>
          ...
          storage is completely secure. Users should exercise caution when
      ...
      <p style={{ fontSize: 15 }}>
        ...
        consent. If you have any questions or concerns regarding electronic
        communications or wish to update your communication preferences, please
        contact us using the contact information provided in the Terms &
        Conditions.
      </p>
      ...
      <p style={{ fontSize: 15 }}>
        ...
        Investments LLC regarding the use of the website
      </p>
      ...
      <p style={{ fontSize: 15 }}>
        ...
        Investments LLC. Any attempted assignment, transfer, or delegation
        without such consent shall be null and void. Epiidosis Investments LLC
      ...
      <p style={{ fontSize: 15 }}>
        ...
        transferred to the acquiring entity as part of the transaction. Users
        consent to such transfer of data and agree to be bound by any successor
      ...
      <p style={{ fontSize: 15 }}>
        ...
        headquartered in Dubai, recognizes the importance of ensuring that all
        users understand their rights and obligations regarding the use of our
        website and services. Therefore, if our website or services are offered
        in multiple languages, we will make the terms and conditions available
        in those languages to accommodate the diverse linguistic preferences of
        our users. This approach aims to enhance transparency and comprehension,
        enabling users to make informed decisions about their use of our website
        and services.
      </p>
      ...
      <p style={{ fontSize: 15 }}>
        ...
        thoughts, ideas, and recommendations with us to help us better
        understand your needs and preferences. Your feedback is instrumental in
        shaping our future developments and ensuring that we continue to meet
      ...
      <p style={{ fontSize: 15 }}>
        ...
        against anyone who, in its sole discretion, violates this provision,
        including without limitation, reporting such activity to law enforcement
        authorities.
      </p>
      ...
      <p style={{ fontSize: 15 }}>
        ...
        and conditions is organized under specific headings, allowing users to
        locate relevant information efficiently. Our commitment to clarity and
        transparency extends to the structure and formatting of the document,
        facilitating comprehension and compliance with the outlined terms.
      </p>
      ...
      <p style={{ fontSize: 15 }}>
        ...
        using our website, epiidosisinvestments.com. For any questions or
        assistance regarding the Terms & Conditions, please contact us using the
        following details:
      </p>

      <ul className="list-disc">
        <li>Email: legal@epiidosisinvestments.com </li>
