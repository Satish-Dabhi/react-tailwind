...
If you have any questions or concerns about our privacy practices or this policy, please contact us at dpo@epiidosisinvestments.com. Thank you for entrusting Epiidosis Investments LLC with your personal information.
    ...
    <h1 className="text-4xl mt-12 mb-5 text-primary font-semibold font-inria">
    Disclosure of Personal Information
    </h1>
    <ol className="list-disc font-inter text-lg p-5 space-y-5">
      <li>
      Personal information may be disclosed to third-party service providers, affiliates, and business partners for the purpose of delivering financial services and support. We may also disclose personal information in response to legal obligations, regulatory requirements, or to protect our rights, property, or safety, or the rights, property, or safety of others.
      </li>
      <li>
      We take reasonable measures to safeguard personal information from unauthorized access, use, disclosure, alteration, or destruction. We implement physical, technical, and administrative security controls to protect personal information stored in electronic and physical formats.
      </li>
