...
const LatestCardUiInvest = ({ data }) => {
  ...
  return (
    <div>
      <div className="flex relative max-w-[20rem] h-fit overflow-hidden border shadow-2xl bg-white z-10">
...
export default LatestCardUiInvest;
